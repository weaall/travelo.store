...
export const MainContainer = tw.div`flex flex-col w-full min-h-screen-16 justify-center bg-main-img bg-no-repeat bg-center
mobile:bg-white mobile:bg-main-img-mobile mobile:bg-cover`
...
export const SearchInput = tw.input`text-sm px-2 flex-1 font-bold outline-none truncate`
