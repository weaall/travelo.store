...
export const AddTextField = tw.textarea`min-h-36 py-3 ps-4 pe-20 block border w-full my-2
...
w-full mx-1 text-lg font-medium px-5 py-3 rounded-xl bg-black text-white cursor-pointer
